...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  // Memoize the context value so consumers re-render only when a field they read actually
  // changes — not on every incidental provider render. (The handlers below are all stable
  // useCallbacks, so the identity only churns on real state changes.)
