...
const SPAIN_SOURCES: Source[] = [
  ...
  },
  {
    ...
    lean: -0.1,
    confidence: 0.7,
    leanRationale: "Center: Barcelona-based daily, broadly centrist (national politics desk).",
  },
  {
  ...
  {
    id: "es-20minutos",
    title: "20minutos — Nacional",
    url: "https://www.20minutos.es/rss/nacional/",
    kind: "news",
    topic: "politics",
    lean: 0.0,
    confidence: 0.65,
    leanRationale: "Center: mass-market national news.",
  },
  {
    id: "es-rtve",
    title: "RTVE — Noticias",
